            ...
            e[n] = function(e, t, n) {
                ...
                _initNavbar: function(t) {
                    if (this.trigger("initNavbar:before", t), !t.children("." + s.navbar).length) {
                        ...
                        this.opts.navbar.add && t.addClass(s.hasnavbar), o.append('<a class="' + s.title + '"' + (l.length ? ' href="' + l + '"' : "") + ">" + '<span class="special-first-letter">' + r[0] + "</span>" + r.substr(1 , r.length - 1) + "</a>").prependTo(t), this.trigger("initNavbar:after", t)
                    }
                },
