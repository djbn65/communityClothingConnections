 ...
 */
$conf['settings']['app.title'] = 'Event Signups';			// application title
...
$conf['settings']['admin.email'] = 'djbn65@mst.edu';         // email address of admin user
$conf['settings']['admin.email.name'] = 'Community Clothing Connections Administrator';	// name to be used in From: field when sending automatic emails
...
$conf['settings']['script.url'] = 'https://ccconnections.info/booked/Web';   	// public URL to the Web directory of this instance. this is the URL that appears when you are logging in. leave http: or https: off to auto-detect
$conf['settings']['image.upload.directory'] = 'http://fccity.cu.cc/images'; // full or relative path to where images will be stored
$conf['settings']['image.upload.url'] = 'http://fccity.cu.cc/images';       // full or relative path to show uploaded images from
$conf['settings']['cache.templates'] = 'false';                  // true recommended, caching template files helps web pages render faster
$conf['settings']['use.local.jquery'] = 'true';                // false recommended, delivers jQuery from Google CDN, uses less bandwidth
...
$conf['settings']['home.url'] = 'https://ccconnections.info'; 	      					// the url to open when the logo is clicked
$conf['settings']['logout.url'] = 'https://ccconnections.info/booked/Web/?'; 	      					// the url to be directed to after logging out
...
$conf['settings']['ics']['subscription.key'] = 'Feuerwerk12';              // must be set to allow webcal subscriptions
...
$conf['settings']['database']['user'] = 'ccconnec';        // database user with permission to the booked database
$conf['settings']['database']['password'] = '4gyJ1f44Hd';
$conf['settings']['database']['hostspec'] = '31.22.4.238';        // ip, dns or named pipe
$conf['settings']['database']['name'] = 'ccconnec_booked';
/**
 ...
 */
$conf['settings']['install.password'] = 'Feuerwerk12';
/**
 * Pages
 */
