...
<div id="page-schedule" style="margin-top: 8rem">
	...
	<div class="row-fluid">
		<div id="reservations-left" class="col-xs-12 default-box" style="margin-bottom: .75em; background-color: #d2d1d1; text-shadow: 1px 1px 10px black;">

			<div class="reservations-left-content">
				<h5 style="font-size:1.2em; font-weight: 900"><strong style="color: #ffd714">Help!</strong> To sign up for an event, just click on the event shown and request to join it. An admin will accept your request as soon as possible. Please do not make your own events, as they will be rejected.<a href="#" class="pull-right toggle-sidebar" title="Hide Help Panel"><i class="glyphicon glyphicon-remove"></i></a></h5>
			</div>
		</div>

		<div id="reservations" class="col-xs-12" style="padding-left: 0; padding-right: 0; width: 100%">
			<div style="margin-bottom: 0.75rem;">
				<a href="#" id="restore-sidebar" title="Show Reservation Filter" class="hidden toggle-sidebar" style="color: #ffe048; font-weight: 900; margin-bottom: 1rem; text-shadow: 1px 1px 30px white">Help <i
