...
<div class="page-search-availability default-box" style="margin-top: 8rem">
	<h1><span class="special-first-letter">S</span>earch Availability</h1>
    <form role="form" name="searchForm" id="searchForm" method="post"
        ...
        <div class="form-group col-xs-12 col-sm-3">
            <div class="checkbox">
                ...
                <label for="anyResource" style="color:#888; font-weight: bolder; text-shadow: 1px 1px 20px #f2f2f2">{translate key=AnyResource}</label>
            </div>
        </div>
        ...
        <div class="form-group col-xs-12 col-sm-9">
            <div class="btn-group margin-bottom-15" data-toggle="buttons">
                <label class="btn btn-default active">
                    ...
                    <span class="hidden-xs" style="color:#154360">{translate key=Today},</span>
                    <span style="color:#154360"> {format_date date=$Today key=calendar_dates}</span>
                </label>
                <label class="btn btn-default">
                    <input type="radio" id="tomorrow" value="tomorrow" {formname key=AVAILABILITY_RANGE} />
                    <span class="hidden-xs" style="color:#154360">{translate key=Tomorrow},</span>
                    <span style="color:#154360"> {format_date date=$Tomorrow key=calendar_dates}</span>
                </label>
                <label class="btn btn-default">
                    <input type="radio" id="thisweek" value="thisweek" {formname key=AVAILABILITY_RANGE} />
                    <span class="hidden-xs" style="color:#154360">{translate key=ThisWeek}</span>
                    <span class="visible-xs" style="color:#154360">{translate key=Week}</span>
                </label>
                <label class="btn btn-default">
                    <input type="radio" id="daterange" value="daterange" {formname key=AVAILABILITY_RANGE} />
                    <i class="fa fa-calendar"></i><span class="hidden-xs" style="color:#154360"> {translate key=DateRange}</span>
                </label>
            </div>
            <div class="">
                ...
                <a href="#" data-toggle="collapse" data-target="#advancedSearchOptions" style="color:#888; font-weight: bolder; text-shadow: 1px 1px 20px #f2f2f2">{translate key=MoreOptions}</a>
            </div>
            <div class="clearfix"></div>
