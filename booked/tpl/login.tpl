...
<div id="page-login" style="margin-top: 8rem">
	...
	<div class="col-md-offset-3 col-md-6 col-xs-12 " style="    box-shadow: 4px 4px 10px black; padding: 0;">
			...
			<div id="login-box" class="col-xs-12 default-box straight-top">
				...
				<div class="col-xs-12 {if $ShowRegisterLink}col-sm-6{/if}">
					<div class="checkbox">
						...
						<label for="rememberMe" style="font-weight: bold">{translate key=RememberMe}</label>
					</div>
				</div>
			...
			<div id="login-footer" class="col-xs-12">
				{if $ShowForgotPasswordPrompt}
					<div id="forgot-password" class="col-xs-12 col-sm-6">
						<a href="{$ForgotPasswordUrl}" {$ForgotPasswordUrlNew} class="btn btn-link pull-left-sm" style="color: #93FC04"><span><i
										class="glyphicon glyphicon-question-sign" style="color: white"></i></span> {translate key='ForgotMyPassword'}</a>
					</div>
				{/if}
			</div>
