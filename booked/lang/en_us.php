...
class en_us extends Language
{
	...
	protected function _LoadStrings()
	{
		...
		$strings['PasswordControlledExternallyError'] = 'Your password is controlled by an external system and cannot be updated here. Please contact cccbus@ccconnections.info for help.';
		...
		$strings['EditProfile'] = "<span class='special-first-letter'>E</span>dit My Profile";
		...
		$strings['ApplicationManagement'] = 'Management';
